...
public class MockDatabase {
    ...
    public static final MojangId SK_USER = new MojangId(UUID.fromString("0ea8eca3-dbf6-47cc-9d1a-c64551ca975c"), "sk89q");
    public static final MojangId VINCENT_USER = new MojangId(UUID.fromString("a31a3813-4b01-4022-ba46-29415975c4c5"), "vincent");
    ...
    private static final String DATA_SCHEMA = "skcraft_plume";
    ...
    public DataSource createDataSource() {
        ...
        ds.setJdbcUrl("jdbc:mysql://localhost:3306/skcraft_plume");
        ds.setUsername("root");
        ds.setPassword("");
        return ds;
    }
